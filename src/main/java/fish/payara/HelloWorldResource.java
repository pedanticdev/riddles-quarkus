...
public class HelloWorldResource {
    ...
    @Counted(value = "helloEndpointCount", description = "Count of calls to the hello endpoint")
    @Timed(value = "helloEndpointTime", description = "Time taken to execute the hello endpoint")
